...
print("imaga_gary_shape: ", image_gary.shape)
image_gary = image_gary.transpose(2, 0, 1)
print("image_gary_transpose(2, 0, 1): ", image_gary.shape)

batch_image_gary = np.repeat(image_gary[np.newaxis, :, :, :], 15, axis=0)
print("batch_image_gary_shape: ",batch_image_gary.shape)

W4, b4 =init_weigit(num_filters=10, data_dim=1, kernel_size=3, stride=2)
conv4 = Conv2D(W4, b4)
output4 = conv4.forward(batch_image_gary)
print("batch_image_gary_Conv_Layer_size ", output4.shape)

...
model_1 = MyModel(input_size=784, hidden_size_list=[256, 100, 64, 32], output_size=10,
                  decay_lamda=decay_lambda, use_batchnorm=True)
...
for epoch in range(epochs):
    ...
    if epoch % 50 == 0:
        print("Model_1 Epoch: {} Train Loss : {:.4f} Train Accuracy: {:.4f} Test Accuracy: {:.4f}".format(epoch+1, loss, train_acc, test_acc))